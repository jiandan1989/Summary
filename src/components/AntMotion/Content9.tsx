...
import { getChildrenToRender } from '../../utils/bootstrap';
import { Avatar } from 'antd';

class Content9 extends React.PureComponent<any, any> {
			...
			<OverPack key={i.toString()} {...block}>
				...
				>
					<div key="image" {...item.img}>
						<Avatar style={{ width: 98, height: 98 }} src={item.img.children} />
